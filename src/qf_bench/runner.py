...
class BenchmarkRunner:
    """
    Orchestrates the benchmarking process by running models on datasets
    and calculating metrics.
    """

    def __init__(
        self,
        models: List[FoldingModel],
        ...
        Args:
            models: List of FoldingModel instances to evaluate.
            data_loader: BenchmarkDataLoader instance for fetching targets.
            output_dir: Directory where results and predicted PDBs will be saved.
        """
        self.models = models
    ...
    def run_benchmark(
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            future_to_task = {
                executor.submit(process_target_model, t, m): (t, m) for t, m in tasks
            }
        ...
        metrics_to_show = ["rmsd", "tm_score", "plddt"]
